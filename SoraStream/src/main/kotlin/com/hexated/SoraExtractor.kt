...
import com.lagradost.cloudstream3.utils.newSubtitleFile // FIX: Menambahkan impor yang hilang
...
object SoraExtractor : SoraStream() {
    ...
    suspend fun invokeMapple(
        ...
        val res = app.post(
            url,
            // Perbaikan: Menggunakan toMediaTypeOrNull("application/json") yang benar tanpa argumen berlebihan
            requestBody = data.toRequestBody("application/json".toMediaTypeOrNull()),
            headers = headers
        ).text
        val videoLink =
    ...
    suspend fun invokeVidsrccx(
        ...
        val video = app.post(
            ...
            // Perbaikan: Menggunakan toMediaTypeOrNull("application/json") yang benar
            requestBody = mapOf("filePath" to filePath).toJson().toRequestBody("application/json".toMediaTypeOrNull()) 
