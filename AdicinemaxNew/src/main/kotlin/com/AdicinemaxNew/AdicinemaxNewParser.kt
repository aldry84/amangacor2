...
data class AdicinemaxNewAPI(
    val name: String,
    val fields: AdicinemaxNewFields,
    val createTime: String,
    val updateTime: String,
)

data class AdicinemaxNewFields(
    val links: AdicinemaxNewLinks,
)

data class AdicinemaxNewLinks(
    val arrayValue: AdicinemaxNewArrayValue,
)

data class AdicinemaxNewArrayValue(
    val values: List<AdicinemaxNewValue>,
)

data class AdicinemaxNewValue(
    val mapValue: AdicinemaxNewMapValue,
)

data class AdicinemaxNewMapValue(
    val fields: AdicinemaxNewFields2,
)

data class AdicinemaxNewFields2(
    val href: AdicinemaxNewHref,
    val quality: AdicinemaxNewQuality,
    val source: AdicinemaxNewSource,
)

data class AdicinemaxNewHref(
    val stringValue: String,
)

data class AdicinemaxNewQuality(
    val stringValue: String,
)

data class AdicinemaxNewSource(
    val stringValue: String,
)
