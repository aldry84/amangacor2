...
class AdicinemaxNewPlugin: Plugin() {
    ...
    override fun load(context: Context) {
        ...
        val mainApis = listOf(
            AdicinemaxNew(sharedPref), AdicinemaxNewLite(),
            AdicinemaxNewTorrent(), AdicinemaxNewAnime(), AdicinemaxNewTorrentAnime()
        )
        ...
        //registerMainAPI(AdicinemaxNewTest(sharedPref))
