package mytmdbprovider // PACKAGE DIGANTI
...
// Import Data Class Anda (harus ada di paket yang sama)
// Pastikan file DataClasses.kt/SourceData/SubtitleData ada di paket mytmdbprovider
// import mytmdbprovider.SourceData 

// Inisialisasi GSON sekali
private val GSON = Gson()

// Asumsi Data Class yang diperlukan (Definisikan di DataClasses.kt):
data class SourceData(val file: String, val label: String) 
// data class SubtitleData(val file: String, val label: String, val kind: String)
