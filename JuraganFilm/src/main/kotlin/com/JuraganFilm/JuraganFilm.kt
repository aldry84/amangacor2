...
class JuraganFilm : MainAPI() {
    ...
    // Helper: Mengubah HTML menjadi Data Film
    ...
    override suspend fun loadLinks(
        ...
        document.select("iframe").forEach { iframe ->
            ...
            if (src.contains("juragan.info") || src.contains("juraganfilm")) {
                ...
                // Cari Link Cloudbeta (Video Utama)
                ...
                if (innerSrc != null) {
                    ...
                    if (decodedUrl.contains(".m3u8")) {
                        // Menggunakan M3u8Helper dengan parameter 'source' yang benar
                ...
                // Cari Link GDrivePlayer (Cadangan)
