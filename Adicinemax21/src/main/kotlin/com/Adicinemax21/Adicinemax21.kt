...
open class Adicinemax21 : TmdbProvider() {
    ...
    override suspend fun load(url: String): LoadResponse? {
        ...
        // REMOVED: ?: throw ErrorLoadingException("Invalid data format") 
        // Reason: 'try' block returns non-null Data, and 'catch' block throws exception.
        // Therefore, the result of the expression is always Data (never null), making '?:' unreachable.
