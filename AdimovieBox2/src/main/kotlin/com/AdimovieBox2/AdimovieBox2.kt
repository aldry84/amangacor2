...
class AdimovieBox2Provider : MainAPI() {
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        // --- PERBAIKAN: Mengambil data dari objek subject sesuai temuan CURL ---
        val subject = data["subject"] ?: data // fallback ke root data jika struktur berbeda
        ...
        if (type == TvType.TvSeries) {
            ...
            // Logika season-info tetap dipertahankan
    ...
    override suspend fun loadLinks(
        ...
        // Logika loadLinks tetap sama karena sudah berfungsi dengan baik
        return true
    }

    // Fungsi pembantu identifyID, fetchMetaData, dll tetap di bawah sini...
    private suspend fun identifyID(title: String, year: Int?, rating: Double?): Pair<Int?, String?> {
        return Pair(null, null) // Implementasi pencarian TMDB seperti kode awal Anda
    }
